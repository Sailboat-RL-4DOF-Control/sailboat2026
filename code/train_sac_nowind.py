"""Train the 14-dimensional feed-forward SAC policy.

Run in a terminal with ``python train_sac_nowind.py`` or open this file in an
...
if __name__ == "__main__":
    ...
    if arguments.output_dir is None:
        arguments.output_dir = str(
            SCRIPT_DIR / "trained_models" / f"sac_nowind_seed{arguments.seed}"
        )
    train(arguments)
